    ...
    <header className="flex flex-col gap-4 rounded-[1.75rem] border border-slate-200/80 bg-white/80 px-4 py-4 shadow-[0_20px_70px_rgba(15,23,42,0.04)] backdrop-blur xl:flex-row xl:items-center xl:justify-between xl:px-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/student/dashboard" aria-label="View profile" className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50">
